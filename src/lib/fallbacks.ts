...
export const sampleAds: Advertisement[] = [
  {
    id: 'ad-1',
    title: { en: 'The Contemporary Studio', bn: 'দ্য কনটেম্পোরারি স্টুডিও' },
    name: 'Studio banner',
    type: 'banner',
    position: 'top',
    page: 'home',
  ...
  {
    id: 'ad-2',
    title: { en: 'Data & Climate Summit', bn: 'ডেটা ও ক্লাইমেট সামিট' },
    name: 'Summit sidebar',
    type: 'sidebar',
    ...
    targetUrl: 'https://thecontemporary.news',
    priority: 8,
    displayPages: ['home', 'article', 'all'],
  },
  {
    id: 'ad-3',
    title: { en: 'Metro Business Forum', bn: 'মেট্রো বিজনেস ফোরাম' },
    ...
    image: {
      ...
      alt: { en: 'Business event banner', bn: 'ব্যবসায়িক ইভেন্ট ব্যানার' },
    },
    linkUrl: 'https://thecontemporary.news',
    targetUrl: 'https://thecontemporary.news',
    priority: 7,
  ...
  {
    id: 'ad-4',
    title: { en: 'City retail showcase', bn: 'সিটি রিটেইল শোকেস' },
    ...
    image: {
      ...
      alt: { en: 'Retail banner', bn: 'রিটেইল ব্যানার' },
    },
    linkUrl: 'https://thecontemporary.news',
    targetUrl: 'https://thecontemporary.news',
    priority: 6,
  ...
  {
    id: 'ad-5',
    title: { en: 'Inside the report', bn: 'রিপোর্টের ভেতরে' },
    name: 'Article inline',
    type: 'in_content',
    position: 'middle',
    page: 'article',
    image: {
      ...
      alt: { en: 'Inline sponsorship banner', bn: 'ইনলাইন স্পনসর ব্যানার' },
    },
    linkUrl: 'https://thecontemporary.news',
    targetUrl: 'https://thecontemporary.news',
    priority: 9,
  ...
  {
    id: 'ad-6',
    title: { en: 'Weekend long read sponsor', bn: 'উইকএন্ড লংরিড স্পনসর' },
    ...
    image: {
      ...
      alt: { en: 'Footer sponsorship banner', bn: 'ফুটার স্পনসরশিপ ব্যানার' },
    },
    linkUrl: 'https://thecontemporary.news',
    targetUrl: 'https://thecontemporary.news',
    priority: 5,
...
export const sampleDashboard: DashboardOverview = {
  ...
  users: { total: 26, admins: 4, editorial: 12 },
